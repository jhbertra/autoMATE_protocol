...
public class NodeCommandMessageSubParser extends ClientMessageSubParser<NodeCommandMessage> {
	 ...
	 */
	@Override
	public NodeCommandMessage parseXml(String xml) throws XmlFormatException,
	...
	public void endElement(String uri, String localName, String qName)
		...
		if(qName.equals("content")) {
			this.message = new NodeCommandMessage(parameters, commandId, responseCode, commandMessage);
		} else {
