...
public class ServerNodeCommandMessageSubParser extends ServerMessageSubParser<ServerNodeCommandMessage> {
	 ...
	 */
	@Override
	public ServerNodeCommandMessage parseXml(String xml) throws XmlFormatException,
	...
	public void endElement(String uri, String localName, String qName)
		...
		if(qName.equals("content")) {
			this.message = new ServerNodeCommandMessage(parameters, nodeId, name, commandId, args);
		} else {
